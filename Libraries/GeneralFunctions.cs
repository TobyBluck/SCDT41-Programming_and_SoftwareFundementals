       ...
       */
        public static string generateId(string dataPath, string text)
        {
            ...
            try
            {
                ...
                {
                    numInc++; //Checks to see if the file already exists. if so, increments the number and execute only that line, as can while loops and for loops. 
                }
                id = idText + numInc;
            }
            catch (Exception e)
        ...
        */
        public static string getOptionalInput(string message, bool skip)
        {
            ...
            try
            {
                if(skip) //if conidtion is skip then do 
                {
        ...
        */
        public static DateTime getDateTimeInput()
        {
            ...
            try
            {
                while(!int.TryParse(getRequiredInput("Day: "), out day)); //gets input from user until number is given. ! before int inverse boolean values true = false etc. 
